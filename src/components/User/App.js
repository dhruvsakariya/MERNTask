              ...
              <div class="card mb-4">
                <div class="card-body text-center">
                  ...
                  <div class="d-flex justify-content-center my-3">
                    ...
                    <button
                      type="button"
                      class="btn btn-outline-primary ms-1 py-0"
                    >
                      Message
                    </button>
                  </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <p class="text-muted mb-0">Sakariya</p>
                    </div>
                  </div>
                  <hr />
                  <div class="row">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="card mb-4 mb-md-0">
                    <div class="card-body">
                      <p class="mb-4">
                        <i class="fa-solid fa-person-dots-from-line mx-2 "></i>{" "}
                        Hobbies
                      </p>
                ...
                <div class="col-md-6">
                  <div class="card mb-4 mb-md-0">
                    <div class="card-body">
                      <p class="mb-4">
                        <i class="fa-solid fa-kitchen-set mx-2 "></i> Skills
                      </p>
                      <p class="mb-1" style={{ fontSize: ".77rem" }}>
                        Web Design
                      </p>
